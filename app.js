...
const Weather = {
    searchWeather: async function () {
        try{
            ...
            const api = `${proxy}https://api.openweathermap.org/data/2.5/weather?lat=${Location.coords.latitude}&lon=${Location.coords.longitude}&appid=f7383d6d274de894f79cc4c54581bd15`;
            console.log("api: " + api);
